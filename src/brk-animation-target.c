...
static void
object_weak_notify(gpointer data, GObject *object) {
...
static void
brk_property_animation_target_set_value(BrkAnimationTarget *target, double value) {
...
static void
brk_property_animation_target_get_property(
...
static void
brk_property_animation_target_set_property(
...
brk_property_animation_target_class_init(BrkPropertyAnimationTargetClass *klass) {
     ...
     * Since: 1.2
     */
    property_props[PROPERTY_PROP_OBJECT] = g_param_spec_object(
        "object", NULL, NULL, G_TYPE_OBJECT,
     ...
     * Since: 1.2
     */
    property_props[PROPERTY_PROP_PSPEC] = g_param_spec_param(
        "pspec", NULL, NULL, G_TYPE_PARAM,
        G_PARAM_READWRITE | G_PARAM_CONSTRUCT_ONLY | G_PARAM_STATIC_STRINGS
    );

    g_object_class_install_properties(object_class, LAST_PROPERTY_PROP, property_props);
}
 ...
 */
BrkAnimationTarget *
brk_property_animation_target_new(GObject *object, const char *property_name) {
    GParamSpec *pspec;
 ...
 */
BrkAnimationTarget *
brk_property_animation_target_new_for_pspec(GObject *object, GParamSpec *pspec) {
    g_return_val_if_fail(G_IS_OBJECT(object), NULL);
    g_return_val_if_fail(G_IS_PARAM_SPEC(pspec), NULL);

    return g_object_new(BRK_TYPE_PROPERTY_ANIMATION_TARGET, "object", object, "pspec", pspec, NULL);
}
