...
G_DEFINE_TYPE_WITH_CODE(
    BrkBin, brk_bin, GTK_TYPE_WIDGET,
    G_ADD_PRIVATE(BrkBin) G_IMPLEMENT_INTERFACE(GTK_TYPE_BUILDABLE, brk_bin_buildable_init)
)
...
static void
brk_bin_get_property(GObject *object, guint prop_id, GValue *value, GParamSpec *pspec) {
    BrkBin *self = BRK_BIN(object);
...
static void
brk_bin_set_property(GObject *object, guint prop_id, const GValue *value, GParamSpec *pspec) {
    BrkBin *self = BRK_BIN(object);
