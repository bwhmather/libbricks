...
static void brk_toolbar_view_buildable_init (GtkBuildableIface *iface);

G_DEFINE_FINAL_TYPE_WITH_CODE (BrkToolbarView, brk_toolbar_view, GTK_TYPE_WIDGET,
...
{
  if (self->top_bar_style == BRK_TOOLBAR_FLAT &&
  ...
  if (self->bottom_bar_style == BRK_TOOLBAR_FLAT &&
...
static void
brk_toolbar_view_measure (GtkWidget      *widget,
...
static void
brk_toolbar_view_size_allocate (GtkWidget *widget,
                                int        width,
                                int        height,
                                int        baseline)
{
...
static void
brk_toolbar_view_get_property (GObject    *object,
                               guint       prop_id,
                               GValue     *value,
                               GParamSpec *pspec)
{
...
static void
brk_toolbar_view_set_property (GObject      *object,
                               guint         prop_id,
                               const GValue *value,
                               GParamSpec   *pspec)
{
...
static void
brk_toolbar_view_buildable_add_child (GtkBuildable *buildable,
                                      GtkBuilder   *builder,
                                      GObject      *child,
                                      const char   *type)
{
 ...
 */
void
brk_toolbar_view_set_content (BrkToolbarView *self,
                              GtkWidget      *content)
{
 ...
 */
void
brk_toolbar_view_add_top_bar (BrkToolbarView *self,
                              GtkWidget      *widget)
{
  g_return_if_fail (BRK_IS_TOOLBAR_VIEW (self));
 ...
 */
void
brk_toolbar_view_add_bottom_bar (BrkToolbarView *self,
                                 GtkWidget      *widget)
{
  g_return_if_fail (BRK_IS_TOOLBAR_VIEW (self));
  g_return_if_fail (GTK_IS_WIDGET (widget));
 ...
 */
void
brk_toolbar_view_remove (BrkToolbarView *self,
                         GtkWidget      *widget)
{
  GtkWidget *parent;
 ...
 */
void
brk_toolbar_view_set_top_bar_style (BrkToolbarView  *self,
                                    BrkToolbarStyle  style)
{
  g_return_if_fail (BRK_IS_TOOLBAR_VIEW (self));
 ...
 */
void
brk_toolbar_view_set_bottom_bar_style (BrkToolbarView  *self,
                                       BrkToolbarStyle  style)
{
  g_return_if_fail (BRK_IS_TOOLBAR_VIEW (self));
  g_return_if_fail (style <= BRK_TOOLBAR_RAISED_BORDER);
 ...
 */
void
brk_toolbar_view_set_reveal_top_bars (BrkToolbarView *self,
                                      gboolean        reveal)
{
  g_return_if_fail (BRK_IS_TOOLBAR_VIEW (self));
 ...
 */
void
brk_toolbar_view_set_reveal_bottom_bars (BrkToolbarView *self,
                                         gboolean        reveal)
{
  g_return_if_fail (BRK_IS_TOOLBAR_VIEW (self));
 ...
 */
void
brk_toolbar_view_set_extend_content_to_top_edge (BrkToolbarView *self,
                                                 gboolean        extend)
{
  g_return_if_fail (BRK_IS_TOOLBAR_VIEW (self));
 ...
 */
void
brk_toolbar_view_set_extend_content_to_bottom_edge (BrkToolbarView *self,
                                                    gboolean        extend)
{
  g_return_if_fail (BRK_IS_TOOLBAR_VIEW (self));
