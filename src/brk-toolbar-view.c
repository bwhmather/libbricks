 ...
 *
 * <picture>
 *   <source srcset="toolbar-view-dark.png" media="(prefers-color-scheme:
 * dark)"> <img src="toolbar-view.png" alt="toolbar-view">
 * </picture>
 *
 * `BrkToolbarView` has a single content widget and one or multiple top and
 * bottom bars, shown at the top and bottom sides respectively.
 *
 * Example of an `BrkToolbarView` UI definition:
 * ```xml
 * <object class="BrkToolbarView">
 *   <child type="top">
 *     <object class="BrkHeaderBar"/>
 *   </child>
 *   <property name="content">
 *     <object class="BrkPreferencesPage">
 *       <!-- ... -->
 *     </object>
 *   </property>
 * </object>
 ...
 *   <source srcset="toolbar-view-flat-1-dark.png" media="(prefers-color-scheme:
 * dark)"> <img src="toolbar-view-flat-1.png" alt="toolbar-view-flat-1">
 * </picture>
 * <picture style="min-width: 33%; display: inline-block;">
 *   <source srcset="toolbar-view-flat-2-dark.png" media="(prefers-color-scheme:
 * dark)"> <img src="toolbar-view-flat-2.png" alt="toolbar-view-flat-2">
 * </picture>
 * <picture style="min-width: 33%; display: inline-block;">
 *   <source srcset="toolbar-view-raised-dark.png" media="(prefers-color-scheme:
 * dark)"> <img src="toolbar-view-raised.png" alt="toolbar-view-raised">
 * </picture>
 *
 * `BrkToolbarView` ensures the top and bottom bars have consistent backdrop
 * styles and vertical spacing. For comparison:
 *
 * <picture style="min-width: 40%; display: inline-block;">
 *   <source srcset="toolbar-view-spacing-dark.png"
 * media="(prefers-color-scheme: dark)"> <img src="toolbar-view-spacing.png"
 * alt="toolbar-view-spacing">
 * </picture>
 * <picture style="min-width: 40%; display: inline-block;">
 *   <source srcset="toolbar-view-spacing-box-dark.png"
 * media="(prefers-color-scheme: dark)"> <img src="toolbar-view-spacing-box.png"
 * alt="toolbar-view-spacing-box">
 * </picture>
 *
 ...
 *
 * ## `BrkToolbarView` as `GtkBuildable`
 *
 * The `BrkToolbarView` implementation of the [iface@Gtk.Buildable] interface
 ...
 * ## Accessibility
 *
 * `BrkToolbarView` uses the `GTK_ACCESSIBLE_ROLE_GROUP` role.
 *
 * Since: 1.4
 */
...
/**
 * BrkToolbarStyle:
 * @BRK_TOOLBAR_FLAT: No background, shadow only for scrolled content
 * @BRK_TOOLBAR_RAISED: Opaque background with a persistent shadow
 * @BRK_TOOLBAR_RAISED_BORDER: Opaque background with a persistent border
 *
 * Describes the possible top or bottom bar styles in an [class@ToolbarView]
 * widget.
 *
 * `BRK_TOOLBAR_FLAT` is suitable for simple content, such as
 ...
 * </picture>
 *
 * `BRK_TOOLBAR_RAISED` style is suitable for content such as
 * [utility
 * panes](https://developer.gnome.org/hig/patterns/containers/utility-panes.html),
 ...
 *
 * `BRK_TOOLBAR_RAISED_BORDER` style is similar to `BRK_TOOLBAR_RAISED`, but
 ...
 * </picture>
 * <picture style="min-width: 33%; display: inline-block;">
 *   <source srcset="toolbar-view-raised-border-dark.png"
 * media="(prefers-color-scheme: dark)"> <img
 * src="toolbar-view-raised-border.png" alt="toolbar-view-raised-border">
 * </picture>
 *
...
struct _BrkToolbarView {
    ...
    BrkToolbarStyle top_bar_style;
    BrkToolbarStyle bottom_bar_style;
...
static void
brk_toolbar_view_buildable_init(GtkBuildableIface *iface);

G_DEFINE_FINAL_TYPE_WITH_CODE(
    BrkToolbarView, brk_toolbar_view, GTK_TYPE_WIDGET,
    G_IMPLEMENT_INTERFACE(GTK_TYPE_BUILDABLE, brk_toolbar_view_buildable_init)
)
...
static void
update_undershoots(BrkToolbarView *self) {
    if (self->top_bar_style == BRK_TOOLBAR_FLAT && !self->extend_content_to_top_edge &&
    ...
    if (self->bottom_bar_style == BRK_TOOLBAR_FLAT && !self->extend_content_to_bottom_edge &&
...
brk_toolbar_view_measure(
    ...
    gtk_widget_measure(self->top_bar, orientation, -1, &top_min, &top_nat, NULL, NULL);
...
static void
brk_toolbar_view_size_allocate(GtkWidget *widget, int width, int height, int baseline) {
    BrkToolbarView *self = BRK_TOOLBAR_VIEW(widget);
    int top_min, top_nat, bottom_min, bottom_nat, content_min = 0;
    int top_height, bottom_height;
    int content_height, content_offset;

    gtk_widget_measure(self->top_bar, GTK_ORIENTATION_VERTICAL, -1, &top_min, &top_nat, NULL, NULL);
    gtk_widget_measure(
    ...
    gtk_widget_allocate(
        self->bottom_bar, width, bottom_height, -1,
...
static void
brk_toolbar_view_dispose(GObject *object) {
    BrkToolbarView *self = BRK_TOOLBAR_VIEW(object);
    ...
    G_OBJECT_CLASS(brk_toolbar_view_parent_class)->dispose(object);
}

static void
brk_toolbar_view_get_property(GObject *object, guint prop_id, GValue *value, GParamSpec *pspec) {
    BrkToolbarView *self = BRK_TOOLBAR_VIEW(object);

    switch (prop_id) {
    case PROP_CONTENT:
        g_value_set_object(value, brk_toolbar_view_get_content(self));
        break;
    case PROP_TOP_BAR_STYLE:
        g_value_set_enum(value, brk_toolbar_view_get_top_bar_style(self));
        break;
    case PROP_BOTTOM_BAR_STYLE:
        g_value_set_enum(value, brk_toolbar_view_get_bottom_bar_style(self));
        break;
    case PROP_REVEAL_TOP_BARS:
        g_value_set_boolean(value, brk_toolbar_view_get_reveal_top_bars(self));
        break;
    case PROP_REVEAL_BOTTOM_BARS:
        g_value_set_boolean(value, brk_toolbar_view_get_reveal_bottom_bars(self));
        break;
    case PROP_EXTEND_CONTENT_TO_TOP_EDGE:
        g_value_set_boolean(value, brk_toolbar_view_get_extend_content_to_top_edge(self));
        break;
    case PROP_EXTEND_CONTENT_TO_BOTTOM_EDGE:
        g_value_set_boolean(value, brk_toolbar_view_get_extend_content_to_bottom_edge(self));
        break;
    case PROP_TOP_BAR_HEIGHT:
        g_value_set_int(value, brk_toolbar_view_get_top_bar_height(self));
        break;
    case PROP_BOTTOM_BAR_HEIGHT:
        g_value_set_int(value, brk_toolbar_view_get_bottom_bar_height(self));
        break;
    default:
...
brk_toolbar_view_set_property(
    ...
    switch (prop_id) {
    case PROP_CONTENT:
        brk_toolbar_view_set_content(self, g_value_get_object(value));
        break;
    case PROP_TOP_BAR_STYLE:
        brk_toolbar_view_set_top_bar_style(self, g_value_get_enum(value));
        break;
    case PROP_BOTTOM_BAR_STYLE:
        brk_toolbar_view_set_bottom_bar_style(self, g_value_get_enum(value));
        break;
    case PROP_REVEAL_TOP_BARS:
        brk_toolbar_view_set_reveal_top_bars(self, g_value_get_boolean(value));
        break;
    case PROP_REVEAL_BOTTOM_BARS:
        brk_toolbar_view_set_reveal_bottom_bars(self, g_value_get_boolean(value));
        break;
    case PROP_EXTEND_CONTENT_TO_TOP_EDGE:
        brk_toolbar_view_set_extend_content_to_top_edge(self, g_value_get_boolean(value));
        break;
    case PROP_EXTEND_CONTENT_TO_BOTTOM_EDGE:
        brk_toolbar_view_set_extend_content_to_bottom_edge(self, g_value_get_boolean(value));
        break;
    default:
        G_OBJECT_WARN_INVALID_PROPERTY_ID(object, prop_id, pspec);
    }
...
static void
brk_toolbar_view_class_init(BrkToolbarViewClass *klass) {
    GObjectClass *object_class = G_OBJECT_CLASS(klass);
    GtkWidgetClass *widget_class = GTK_WIDGET_CLASS(klass);

    object_class->dispose = brk_toolbar_view_dispose;
    object_class->get_property = brk_toolbar_view_get_property;
    object_class->set_property = brk_toolbar_view_set_property;

    widget_class->get_request_mode = brk_toolbar_view_get_request_mode;
    widget_class->measure = brk_toolbar_view_measure;
    widget_class->size_allocate = brk_toolbar_view_size_allocate;
    widget_class->focus = brk_widget_focus_child;
    widget_class->compute_expand = brk_widget_compute_expand;

    /**
     * BrkToolbarView:content: (attributes org.gtk.Property.get=brk_toolbar_view_get_content org.gtk.Property.set=brk_toolbar_view_set_content)
     *
     * The content widget.
     *
     * Since: 1.4
    ...
    /**
     * BrkToolbarView:top-bar-style: (attributes org.gtk.Property.get=brk_toolbar_view_get_top_bar_style org.gtk.Property.set=brk_toolbar_view_set_top_bar_style)
     *
     * Appearance of the top bars.
     *
     * If set to `BRK_TOOLBAR_FLAT`, top bars are flat and scrolling content has a
     ...
     *
     * If set to `BRK_TOOLBAR_RAISED`, top bars have an opaque background and a
     ...
     * [class@TabView], where each page can have a different background.
     *
     * `BRK_TOOLBAR_RAISED_BORDER` is similar to `BRK_TOOLBAR_RAISED`, but the
     ...
     * Since: 1.4
     */
    props[PROP_TOP_BAR_STYLE] = g_param_spec_enum(
        "top-bar-style", NULL, NULL, BRK_TYPE_TOOLBAR_STYLE, BRK_TOOLBAR_FLAT,
        G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS | G_PARAM_EXPLICIT_NOTIFY
    );

    /**
    * BrkToolbarView:bottom-bar-style: (attributes org.gtk.Property.get=brk_toolbar_view_get_bottom_bar_style org.gtk.Property.set=brk_toolbar_view_set_bottom_bar_style)
     *
     * Appearance of the bottom bars.
     *
     * If set to `BRK_TOOLBAR_FLAT`, bottom bars are flat and scrolling content
     ...
     *
     * If set to `BRK_TOOLBAR_RAISED`, bottom bars have an opaque background and a
     * persistent shadow, this is suitable for content such as
     * [utility
     * panes](https://developer.gnome.org/hig/patterns/containers/utility-panes.html),
     ...
     * Since: 1.4
     */
    props[PROP_BOTTOM_BAR_STYLE] = g_param_spec_enum(
        "bottom-bar-style", NULL, NULL, BRK_TYPE_TOOLBAR_STYLE, BRK_TOOLBAR_FLAT,
        G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS | G_PARAM_EXPLICIT_NOTIFY
    );

    /**
     * BrkToolbarView:reveal-top-bars: (attributes org.gtk.Property.get=brk_toolbar_view_get_reveal_top_bars org.gtk.Property.set=brk_toolbar_view_get_reveal_top_bars)
     *
     ...
     * Since: 1.4
     */
    props[PROP_REVEAL_TOP_BARS] = g_param_spec_boolean(
        "reveal-top-bars", NULL, NULL, TRUE,
        G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS | G_PARAM_EXPLICIT_NOTIFY
    );

    /**
     * BrkToolbarView:reveal-bottom-bars: (attributes org.gtk.Property.get=brk_toolbar_view_get_reveal_bottom_bars org.gtk.Property.set=brk_toolbar_view_get_reveal_bottom_bars)
     *
     ...
     * Since: 1.4
     */
    props[PROP_REVEAL_BOTTOM_BARS] = g_param_spec_boolean(
        "reveal-bottom-bars", NULL, NULL, TRUE,
        G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS | G_PARAM_EXPLICIT_NOTIFY
    );

    /**
     * BrkToolbarView:extend-content-to-top-edge: (attributes org.gtk.Property.get=brk_toolbar_view_get_extend_content_to_top_edge org.gtk.Property.set=brk_toolbar_view_set_extend_content_to_top_edge)
     *
     ...
     * Since: 1.4
     */
    props[PROP_EXTEND_CONTENT_TO_TOP_EDGE] = g_param_spec_boolean(
        "extend-content-to-top-edge", NULL, NULL, FALSE,
        G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS | G_PARAM_EXPLICIT_NOTIFY
    );

    /**
     * BrkToolbarView:extend-content-to-bottom-edge: (attributes org.gtk.Property.get=brk_toolbar_view_get_extend_content_to_bottom_edge org.gtk.Property.set=brk_toolbar_view_set_extend_content_to_bottom_edge)
     *
     ...
     * Since: 1.4
     */
    props[PROP_EXTEND_CONTENT_TO_BOTTOM_EDGE] = g_param_spec_boolean(
        "extend-content-to-bottom-edge", NULL, NULL, FALSE,
        G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS | G_PARAM_EXPLICIT_NOTIFY
    );

    /**
     * BrkToolbarView:top-bar-height: (attributes org.gtk.Property.get=brk_toolbar_view_get_top_bar_height)
     *
     ...
     * Since: 1.4
     */
    props[PROP_TOP_BAR_HEIGHT] = g_param_spec_int(
        "top-bar-height", NULL, NULL, 0, G_MAXINT, 0, G_PARAM_READABLE | G_PARAM_STATIC_STRINGS
    );

    /**
     * BrkToolbarView:bottom-bar-height: (attributes org.gtk.Property.get=brk_toolbar_view_get_bottom_bar_height)
     *
     ...
     * Since: 1.4
     */
    props[PROP_BOTTOM_BAR_HEIGHT] = g_param_spec_int(
        "bottom-bar-height", NULL, NULL, 0, G_MAXINT, 0, G_PARAM_READABLE | G_PARAM_STATIC_STRINGS
    );
...
brk_toolbar_view_init(BrkToolbarView *self) {
    ...
    gtk_revealer_set_transition_type(
        GTK_REVEALER(self->bottom_bar), GTK_REVEALER_TRANSITION_TYPE_SLIDE_UP
    );
...
static void
brk_toolbar_view_buildable_add_child(
...
brk_toolbar_view_buildable_init(GtkBuildableIface *iface) {
    ...
    iface->add_child = brk_toolbar_view_buildable_add_child;
}

/**
 * brk_toolbar_view_new:
 *
 * Creates a new `BrkToolbarView`.
 *
 * Returns: the newly created `BrkToolbarView`
 *
 * Since: 1.4
 */
GtkWidget *
brk_toolbar_view_new(void) {
    return g_object_new(BRK_TYPE_TOOLBAR_VIEW, NULL);
}

/**
 * brk_toolbar_view_get_content: (attributes org.gtk.Method.get_property=content)
 * @self: a toolbar view
 *
...
brk_toolbar_view_get_content(BrkToolbarView *self) {
    g_return_val_if_fail(BRK_IS_TOOLBAR_VIEW(self), NULL);

    return self->content;
}

/**
 * brk_toolbar_view_set_content: (attributes org.gtk.Method.set_property=content)
 * @self: a toolbar view
...
brk_toolbar_view_add_top_bar(BrkToolbarView *self, GtkWidget *widget) {
    ...
    g_signal_connect_swapped(
        widget, "notify::visible", G_CALLBACK(update_collapse_style), self->top_box
    );
}

/**
 * brk_toolbar_view_add_bottom_bar:
 * @self: a toolbar view
 * @widget: a widget
 *
...
brk_toolbar_view_add_bottom_bar(BrkToolbarView *self, GtkWidget *widget) {
    ...
    g_signal_connect_swapped(
        widget, "notify::visible", G_CALLBACK(update_collapse_style), self->bottom_box
    );
}

/**
 * brk_toolbar_view_remove:
 * @self: a toolbar view
...
brk_toolbar_view_remove(BrkToolbarView *self, GtkWidget *widget) {
    ...
    if (parent == self->top_box || parent == self->bottom_box) {
        g_signal_handlers_disconnect_by_func(widget, update_collapse_style, parent);
    ...
    if (widget == self->content) {
        brk_toolbar_view_set_content(self, NULL);
        return;
    }

    BRK_CRITICAL_CANNOT_REMOVE_CHILD(self, widget);
}

/**
 * brk_toolbar_view_get_top_bar_style: (attributes org.gtk.Method.get_property=top-bar-style)
 * @self: a toolbar view
 *
...
brk_toolbar_view_get_top_bar_style(BrkToolbarView *self) {
    g_return_val_if_fail(BRK_IS_TOOLBAR_VIEW(self), BRK_TOOLBAR_FLAT);

    return self->top_bar_style;
}

/**
 * brk_toolbar_view_set_top_bar_style: (attributes org.gtk.Method.set_property=top-bar-style)
 * @self: a toolbar view
 * @style: top bar style
 *
...
/**
 * brk_toolbar_view_get_bottom_bar_style: (attributes org.gtk.Method.get_property=bottom-bar-style)
 * @self: a toolbar view
 *
...
/**
 * brk_toolbar_view_set_bottom_bar_style: (attributes org.gtk.Method.set_property=bottom-bar-style)
 * @self: a toolbar view
 * @style: bottom bar style
 *
 * Sets appearance of the bottom bars for @self.
 *
 * If set to `BRK_TOOLBAR_FLAT`, bottom bars are flat and scrolling content has
...
/**
 * brk_toolbar_view_get_reveal_top_bars: (attributes org.gtk.Method.get_property=reveal-top-bars)
 * @self: a toolbar view
 *
...
brk_toolbar_view_get_reveal_top_bars(BrkToolbarView *self) {
    g_return_val_if_fail(BRK_IS_TOOLBAR_VIEW(self), FALSE);

    return gtk_revealer_get_reveal_child(GTK_REVEALER(self->top_bar));
}

/**
 * brk_toolbar_view_set_reveal_top_bars: (attributes org.gtk.Method.set_property=reveal-top-bars)
 * @self: a toolbar view
...
/**
 * brk_toolbar_view_get_reveal_bottom_bars: (attributes org.gtk.Method.get_property=reveal-bottom-bars)
 * @self: a toolbar view
 *
...
/**
 * brk_toolbar_view_set_reveal_bottom_bars: (attributes org.gtk.Method.set_property=reveal-bottom-bars)
 * @self: a toolbar view
...
/**
 * brk_toolbar_view_get_extend_content_to_top_edge: (attributes org.gtk.Method.get_property=extend-content-to-top-edge)
 * @self: a toolbar view
 *
...
/**
 * brk_toolbar_view_set_extend_content_to_top_edge: (attributes org.gtk.Method.set_property=extend-content-to-top-edge)
 * @self: a toolbar view
...
/**
 * brk_toolbar_view_get_extend_content_to_bottom_edge: (attributes org.gtk.Method.get_property=extend-content-to-bottom-edge)
 * @self: a toolbar view
 *
...
/**
 * brk_toolbar_view_set_extend_content_to_bottom_edge: (attributes org.gtk.Method.set_property=extend-content-to-bottom-edge)
 * @self: a toolbar view
...
/**
 * brk_toolbar_view_get_top_bar_height: (attributes org.gtk.Method.get_property=top-bar-height)
 * @self: a toolbar view
 *
...
brk_toolbar_view_get_top_bar_height(BrkToolbarView *self) {
    g_return_val_if_fail(BRK_IS_TOOLBAR_VIEW(self), 0);

    return self->top_bar_height;
}

/**
 * brk_toolbar_view_get_bottom_bar_height: (attributes org.gtk.Method.get_property=bottom-bar-height)
 * @self: a toolbar view
 *
