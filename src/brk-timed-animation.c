 ...
 *
 * `BrkTimedAnimation` implements a simple animation interpolating the given
 ...
 *
 * If [property@TimedAnimation:reverse] is set to `TRUE`, `BrkTimedAnimation`
 ...
 *
 * Creates a new `BrkTimedAnimation` on @widget to animate @target from @from
 * to @to.
 *
