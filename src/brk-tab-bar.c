...
G_DEFINE_FINAL_TYPE_WITH_CODE(
    BrkTabBar, brk_tab_bar, GTK_TYPE_WIDGET,
...
static void
set_extra_drag_preferred_action(BrkTabBar *self, GdkDragAction preferred_action) {
...
static gboolean
extra_drag_drop_cb(
    BrkTabBar *self, BrkTabPage *page, GValue *value, GdkDragAction preferred_action
) {
...
extra_drag_value_cb(BrkTabBar *self, BrkTabPage *page, GValue *value) {
...
static GdkDragAction
extra_drag_value_notify(BrkTabBar *self, GValue *value) {
...
static gboolean
brk_tab_bar_focus(GtkWidget *widget, GtkDirectionType direction) {
...
static void
brk_tab_bar_get_property(GObject *object, guint prop_id, GValue *value, GParamSpec *pspec) {
    BrkTabBar *self = BRK_TAB_BAR(object);
...
static void
brk_tab_bar_set_property(GObject *object, guint prop_id, const GValue *value, GParamSpec *pspec) {
    BrkTabBar *self = BRK_TAB_BAR(object);
...
brk_tab_bar_class_init(BrkTabBarClass *klass) {
     ...
     */
    props[PROP_START_ACTION_WIDGET] = g_param_spec_object(
        "start-action-widget", NULL, NULL, GTK_TYPE_WIDGET,
        G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS | G_PARAM_EXPLICIT_NOTIFY
    );
     ...
     */
    props[PROP_END_ACTION_WIDGET] = g_param_spec_object(
        "end-action-widget", NULL, NULL, GTK_TYPE_WIDGET,
        G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS | G_PARAM_EXPLICIT_NOTIFY
    );
     ...
     */
    props[PROP_AUTOHIDE] = g_param_spec_boolean(
        "autohide", NULL, NULL, TRUE,
        G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS | G_PARAM_EXPLICIT_NOTIFY
    );
     ...
     */
    props[PROP_TABS_REVEALED] = g_param_spec_boolean(
        "tabs-revealed", NULL, NULL, FALSE, G_PARAM_READABLE | G_PARAM_STATIC_STRINGS
    );
     ...
     */
    props[PROP_EXPAND_TABS] = g_param_spec_boolean(
        "expand-tabs", NULL, NULL, TRUE,
        G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS | G_PARAM_EXPLICIT_NOTIFY
    );
     ...
     */
    props[PROP_IS_OVERFLOWING] = g_param_spec_boolean(
        "is-overflowing", NULL, NULL, FALSE, G_PARAM_READABLE | G_PARAM_STATIC_STRINGS
    );
     ...
     * Since: 1.4
     */
    props[PROP_EXTRA_DRAG_PREFERRED_ACTION] = g_param_spec_flags(
        "extra-drag-preferred-action", NULL, NULL, GDK_TYPE_DRAG_ACTION, 0,
     ...
     * Since: 1.3
     */
    props[PROP_EXTRA_DRAG_PRELOAD] = g_param_spec_boolean(
        "extra-drag-preload", NULL, NULL, FALSE,
        G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS | G_PARAM_EXPLICIT_NOTIFY
    );
    ...
    signals[SIGNAL_EXTRA_DRAG_DROP] = g_signal_new(
        ...
        g_signal_accumulator_first_wins, NULL, NULL, G_TYPE_BOOLEAN, 2, BRK_TYPE_TAB_PAGE,
        G_TYPE_VALUE
    );
    ...
    gtk_widget_class_set_template_from_resource(
        widget_class, "/com/bwhmather/Bricks/ui/brk-tab-bar.ui"
    );
    ...
    g_signal_override_class_handler(
        "extra-drag-value", G_TYPE_FROM_CLASS(klass), G_CALLBACK(extra_drag_value_notify)
    );
...
brk_tab_bar_init(BrkTabBar *self) {
    ...
    g_signal_connect_object(
        adj, "changed", G_CALLBACK(update_is_overflowing), self, G_CONNECT_SWAPPED
    );
}

static void
brk_tab_bar_buildable_add_child(
...
brk_tab_bar_set_view(BrkTabBar *self, BrkTabView *view) {
    ...
    if (self->view) {
        ...
        g_signal_connect_object(
            self->view, "notify::is-transferring-page", G_CALLBACK(update_autohide_cb), self,
            G_CONNECT_SWAPPED
        );
        g_signal_connect_object(
            self->view, "notify::n-pages", G_CALLBACK(update_autohide_cb), self, G_CONNECT_SWAPPED
        );
        g_signal_connect_object(
            self->view, "notify::selected-page", G_CALLBACK(notify_selected_page_cb), self,
            G_CONNECT_SWAPPED
        );
        g_signal_connect_object(
            self->view, "destroy", G_CALLBACK(view_destroy_cb), self, G_CONNECT_SWAPPED
        );
    }
